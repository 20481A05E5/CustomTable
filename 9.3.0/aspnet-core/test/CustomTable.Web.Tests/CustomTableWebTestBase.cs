...
using CustomTable.Models.TokenAuth;
...
{
    public abstract class CustomTableWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CustomTableWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CustomTableWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CustomTableDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CustomTableDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CustomTableDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CustomTableDbContext, Task<T>> func)
        {
            T result;
