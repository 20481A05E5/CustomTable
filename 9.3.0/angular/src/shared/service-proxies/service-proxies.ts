...
@Injectable()
export class SurveyEditorServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return OK
     */
    createSurveyEditorData(body: SurveyEditorDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/SurveyEditor/CreateSurveyEditorData";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateSurveyEditorData(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateSurveyEditorData(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processCreateSurveyEditorData(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    updateSurveyEditorData(body: SurveyEditorUpdateDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/SurveyEditor/UpdateSurveyEditorData";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateSurveyEditorData(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateSurveyEditorData(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processUpdateSurveyEditorData(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    deleteSurveyEditorData(id: number | undefined): Observable<SurveyEditorDto[]> {
        let url_ = this.baseUrl + "/api/services/app/SurveyEditor/DeleteSurveyEditorData?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteSurveyEditorData(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteSurveyEditorData(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<SurveyEditorDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<SurveyEditorDto[]>;
        }));
    }

    protected processDeleteSurveyEditorData(response: HttpResponseBase): Observable<SurveyEditorDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200.push(SurveyEditorDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
     ...
     * @return OK
     */
    getAllSurveyEditorData(): Observable<SurveyEditorDto[]> {
        let url_ = this.baseUrl + "/api/services/app/SurveyEditor/GetAllSurveyEditorData";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllSurveyEditorData(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllSurveyEditorData(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<SurveyEditorDto[]>;
                }
            } else
    ...
    protected processGetAllSurveyEditorData(response: HttpResponseBase): Observable<SurveyEditorDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    getPagedGridData(skipCount: number | undefined, maxResultCount: number | undefined): Observable<SurveyEditorDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/SurveyEditor/GetPagedGridData?";
        if (skipCount === null)
            throw new Error("The parameter 'skipCount' cannot be null.");
        else if (skipCount !== undefined)
            url_ += "SkipCount=" + encodeURIComponent("" + skipCount) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetPagedGridData(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetPagedGridData(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<SurveyEditorDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<SurveyEditorDtoPagedResultDto>;
        }));
    }

    protected processGetPagedGridData(response: HttpResponseBase): Observable<SurveyEditorDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = SurveyEditorDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class SurveyEditorDto implements ISurveyEditorDto {
    id: number;
    order: string | undefined;
    description: string | undefined;
    questions: string | undefined;
    startsurvey: boolean;
    popupquestion: boolean;

    constructor(data?: ISurveyEditorDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.startsurvey = _data["startsurvey"];
            this.popupquestion = _data["popupquestion"];
        }
    }

    static fromJS(data: any): SurveyEditorDto {
        data = typeof data === 'object' ? data : {};
        let result = new SurveyEditorDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["startsurvey"] = this.startsurvey;
        data["popupquestion"] = this.popupquestion;
        return data;
    }

    clone(): SurveyEditorDto {
        const json = this.toJSON();
        let result = new SurveyEditorDto();
        result.init(json);
        return result;
...
export interface ISurveyEditorDto {
    id: number;
    order: string | undefined;
    description: string | undefined;
    questions: string | undefined;
...
export class SurveyEditorDtoPagedResultDto implements ISurveyEditorDtoPagedResultDto {
    totalCount: number;
    items: SurveyEditorDto[] | undefined;

    constructor(data?: ISurveyEditorDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(SurveyEditorDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): SurveyEditorDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new SurveyEditorDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): SurveyEditorDtoPagedResultDto {
        const json = this.toJSON();
        let result = new SurveyEditorDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface ISurveyEditorDtoPagedResultDto {
    totalCount: number;
    items: SurveyEditorDto[] | undefined;
}

export class SurveyEditorUpdateDto implements ISurveyEditorUpdateDto {
    id: number;
    order: string | undefined;
    questions: string | undefined;
    startsurvey: boolean;
    ...
    constructor(data?: ISurveyEditorUpdateDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): SurveyEditorUpdateDto {
        data = typeof data === 'object' ? data : {};
        let result = new SurveyEditorUpdateDto();
        result.init(data);
        return result;
    }
...
export interface ISurveyEditorUpdateDto {
    id: number;
    order: string | undefined;
    questions: string | undefined;
    startsurvey: boolean;
